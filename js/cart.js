...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //
    // Тест-драйв бесплатный: сервер платёж не создаёт, а сразу зовёт Катю —
    // она открывает пробный доступ руками.
    async function startCheckout(email) {
        ...
        // Тест-драйв: платежа нет, сервер просто позвал Катю.
        if (data.trial) return { trial: true };
