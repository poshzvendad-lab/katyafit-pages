    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <div class="footer-copy" id="footerCopy">&copy; 2026 Екатерина Пономарёва (@kkatyafit). Все права защищены.</div>
                <div class="footer-copy">Пономарёва Екатерина Сергеевна · Самозанятая (НПД) · ИНН 032312407281</div>
                <div class="footer-copy">Материалы носят общеоздоровительный характер и не являются медицинской услугой</div>
            </div>
        </div>
    </footer>`;
